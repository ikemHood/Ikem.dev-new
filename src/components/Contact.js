...
const contactInfo = [
  { id: 1, label: "Phone", value: "+234 901 334 6176",icon: "fas fa-phone-alt" },
  {
    id: 2,
    label: "Mail",
    value: "ikem@ikem.dev",
    ...
    if (
      ...
      emailjs
        .send(
          ...
          "template_fws8fgx", // template id
          mailData,
          "jzLVRt4ErlDhmrvvY" // public api
        )
        .then(
          (response) => {
            setError(false);
        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="contact-form">
              <h6>Get in touch</h6>
              <p className="lead">
              Eager to hear your innovative ideas and goals. Contact me to start bringing them to life.
              </p>
          ...
          <div className="col-lg-5 ms-auto col-xl-4 pt-5 pt-lg-0">
            ...
            <div className="text-center pt-5">
              <img src="assets/img/contact.svg" className="svg contact-img" alt="image" />
            </div>
          </div>
        </div>
      </div>
